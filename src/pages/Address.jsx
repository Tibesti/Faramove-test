            ...
            >
                <Form>
                    <div className="container py-12 px-5">
                        ...
                        <div className='flex justify-between mb-20 sm:block sm:mb-[30px]'>
                        ...
                        <div className='flex justify-center sm:block'>
                            <BackButton action='Back' addClass='mx-[2%] sm:w-full sm:mx-0 sm:mb-[10px]' link='/' />
                            <PrimaryButton action='Next' addClass='mx-[2%] sm:w-full sm:mx-0' />
                        </div>
                    </div>
                </Form>
            </Formik>
